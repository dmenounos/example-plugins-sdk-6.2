...
/**
 * Provides the local service interface for LMSBorrowing. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dmen
 * @see LMSBorrowingLocalServiceUtil
...
public interface LMSBorrowingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LMSBorrowingLocalServiceUtil} to access the l m s borrowing local service. Add custom service methods to {@link com.slayer.service.impl.LMSBorrowingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
