...
public class ClpSerializer {
	...
	public static Object translateInputLMSBook(BaseModel<?> oldModel) {
		LMSBookClp oldClpModel = (LMSBookClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getLMSBookRemoteModel();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.slayer.NoSuchBookException")) {
			return new com.slayer.NoSuchBookException();
		}

		if (className.equals("com.slayer.NoSuchBorrowingException")) {
			return new com.slayer.NoSuchBorrowingException();
		}
