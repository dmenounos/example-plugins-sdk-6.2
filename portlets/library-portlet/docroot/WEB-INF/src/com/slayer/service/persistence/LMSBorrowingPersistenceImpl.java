...
import com.slayer.NoSuchBorrowingException;
...
public class LMSBorrowingPersistenceImpl extends BasePersistenceImpl<LMSBorrowing>
	...
	public LMSBorrowing findByBookId_First(long bookId,
		...
		throws NoSuchBorrowingException, SystemException {
		...
		throw new NoSuchBorrowingException(msg.toString());
	}
	...
	public LMSBorrowing remove(Serializable primaryKey)
		...
		try {
			...
			if (lmsBorrowing == null) {
				...
				throw new NoSuchBorrowingException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(lmsBorrowing);
		}
		catch (NoSuchBorrowingException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
